...
root_directory = r"D:\Dewetting data\energy"  # Path containing folders like 20_100, 24_100, etc.
save_directory = r"D:\Dewetting data\processed"  # Path to save processed files
